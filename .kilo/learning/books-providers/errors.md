# Registro de Errores — books-providers

> Catálogo de errores específicos encontrados por este agente y sus soluciones.
> Consultar ANTES de cada intervención (protocolo pre-acción §3.5).
