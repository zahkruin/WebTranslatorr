...
- `.kilo/AGENTS.md` — Convenciones del proyecto (async/await, type hints, logging, anti-patrones)
- `.kilo/analysis/03-modules.md` — M7 (Services) es el módulo destino
- `.kilo/analysis/04-agent-mapping.md` — Agente `services` es el responsable de `app/services/`
