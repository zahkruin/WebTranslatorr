...
1. `.kilo/context/10-domain-resolver.md` — Resolución dinámica de dominios
2. `.kilo/context/11-cache.md` — SearchCache (TTL)
3. `.kilo/context/12-zip-extractor.md` — Extracción on-the-fly de ZIPs
4. `.kilo/context/02-configuration.md` — Variables de configuración de servicios
5. `.kilo/context/01-architecture.md` — Cómo encajan los servicios
6. `.kilo/context/05-providers-base.md` — Cómo usan los providers estos servicios
7. `.kilo/AGENTS.md` — Visión general y convenciones
8. `.kilo/styleguide.md` — Convenciones de código
