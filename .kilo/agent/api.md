...
1. `.kilo/context/01-architecture.md` — Arquitectura global y flujo de peticiones
2. `.kilo/context/13-api-endpoints.md` — Documentación de todos los endpoints
3. `.kilo/context/08-torznab-protocol.md` — Protocolo Torznab que exponen los endpoints
4. `.kilo/context/14-deployment.md` — Cómo se despliega el servidor
5. `.kilo/context/02-configuration.md` — Variables que afectan a la API
