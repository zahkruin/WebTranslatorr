...
**Objetivo:** Producir la estructura `.{tool}/` (`.gemini/`, `.cursor/`, etc.) completa con todos los documentos agénticos, usando los datos recolectados en las fases anteriores.
