...
1. `.cursor/context/04-http-client.md` — HttpClient: rate limiting, cloudscraper, retries
2. `.cursor/context/01-architecture.md` — Cómo encaja el scraping en la arquitectura
3. `.cursor/context/05-providers-base.md` — Cómo usan los providers el HttpClient
4. `.cursor/context/06-provider-strategies/` — Estrategias de provider (para entender necesidades de scraping)
5. `.cursor/context/02-configuration.md` — Variables de scraping (RATE_LIMIT, MAX_RETRIES, TIMEOUT)
