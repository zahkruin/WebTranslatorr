...
1. `.cursor/context/07-smart-router.md` — Algoritmo de inferencia, keywords, heurísticas
2. `.cursor/context/01-architecture.md` — Flujo de peticiones y dónde interviene el router
3. `.cursor/context/09-categories.md` — Sistema de categorías Newznab que usa el router
4. `.cursor/context/03-data-models.md` — ContentType, SearchType
5. `.cursor/context/05-providers-base.md` — Cómo el router selecciona providers
