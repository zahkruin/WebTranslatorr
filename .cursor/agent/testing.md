...
1. `.cursor/context/15-testing.md` — Guía de testing, pytest, fixtures, patrones
2. `.cursor/context/03-data-models.md` — Cómo construir SearchResult en tests
3. `.cursor/context/05-providers-base.md` — Cómo mockear HttpClient para tests de provider
4. `.cursor/AGENTS.md` — Visión general y convenciones
5. `.cursor/styleguide.md` — Convenciones de código
6. `.cursor/analysis/04-agent-mapping.md` — Para saber qué agente es responsable de cada módulo
7. `.cursor/phase2-dynamic.json` — Issues detectados y gaps de cobertura
