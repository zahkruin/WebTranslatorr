...
1. `.cursor/context/03-data-models.md` — SearchResult, ProviderCapabilities, enums, excepciones
2. `.cursor/context/09-categories.md` — Sistema de categorías Newznab
3. `.cursor/context/02-configuration.md` — Variables de configuración
4. `.cursor/context/16-known-issues.md` — Problemas conocidos relacionados
5. `.cursor/context/01-architecture.md` — Cómo encajan los modelos en la arquitectura
