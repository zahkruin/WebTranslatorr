...
4. `.cursor/context/` — TODOS los documentos de contexto (01 al 17 + provider strategies)
5. `.cursor/doc-mapping.json` — Mapeo archivos fuente → documentación
6. `.cursor/learning/CENTRAL_ERROR_REGISTRY.md` — Registro central de errores
7. `.cursor/learning/CROSS_AGENT_INSIGHTS.md` — Conocimiento transversal
8. `.cursor/phase2-dynamic.json` — Issues detectados previamente
9. `.cursor/phase1-modules.json` — Estructura de módulos
