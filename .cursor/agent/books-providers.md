...
2. `.cursor/context/06-provider-strategies/` — Estrategia específica del provider que vas a modificar
3. `.cursor/context/04-http-client.md` — HttpClient, rate limiting, cloudscraper
4. `.cursor/context/11-cache.md` — Caché de resultados de búsqueda
5. `.cursor/context/03-data-models.md` — SearchResult, ProviderCapabilities
6. `.cursor/context/09-categories.md` — IDs de categoría para libros (7000-8999)
7. `.cursor/context/17-adding-providers.md` — Guía si vas a crear un provider nuevo
